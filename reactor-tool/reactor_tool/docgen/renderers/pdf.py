...
- Fonts are guaranteed via :class:`~reactor_tool.docgen.fonts.FontManager`
...
- Native vector math: display equations are drawn as real PDF vector paths
  (glyph outlines + fraction/radical bars from :mod:`reactor_tool.docgen.mathtext`)
...
from reactor_tool.docgen.fonts import get_font_manager
from reactor_tool.docgen.images import resolve_image
from reactor_tool.docgen.markdown import InlineSpan, parse_inline
...
from reactor_tool.docgen.themes import CALLOUT_COLORS, get_theme
...
def render_pdf(spec: DocumentSpec, output_path: Path) -> dict[str, Any]:
    ...
    class _VectorMathFlowable(Flowable):
        ...
        :func:`~reactor_tool.docgen.mathtext.math_vector_path` directly on the

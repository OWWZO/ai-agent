...
import org.wwz.ai.domain.agent.genie.config.data.DataAgentModelConfig;
...
import org.wwz.ai.domain.agent.genie.data.dto.ChatModelInfoDto;
import org.wwz.ai.domain.agent.genie.data.dto.ChatSchemaDto;
import org.wwz.ai.domain.agent.genie.data.dto.VectorModelSchema;
import org.wwz.ai.domain.agent.genie.data.dto.VectorSaveReq;
import org.wwz.ai.domain.agent.genie.data.exception.JdbcBizException;
import org.wwz.ai.domain.agent.genie.data.model.StandardColumnType;
import org.wwz.ai.domain.agent.genie.data.provider.jdbc.JdbcDataMetaProvider;
import org.wwz.ai.domain.agent.genie.data.provider.jdbc.JdbcDataProvider;
import org.wwz.ai.domain.agent.genie.data.provider.jdbc.JdbcQueryRequest;
import org.wwz.ai.domain.agent.genie.entity.ChatModelInfo;
import org.wwz.ai.domain.agent.genie.entity.ChatModelSchema;
import org.wwz.ai.domain.agent.genie.mapper.ChatModelInfoMapper;
import org.wwz.ai.domain.agent.genie.mapper.ChatModelSchemaMapper;

...
picks) into a complete, contrast-safe :class:`~reactor_tool.docgen.themes.Theme`
...
:func:`~reactor_tool.docgen.themes.get_theme` resolves by name.
...
from reactor_tool.docgen.slides import relative_luminance
from reactor_tool.docgen.themes import (
    BUILTIN_THEMES,
    Theme,
    get_theme,

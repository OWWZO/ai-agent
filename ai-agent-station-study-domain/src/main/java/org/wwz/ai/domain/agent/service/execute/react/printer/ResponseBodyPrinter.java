package org.wwz.ai.domain.agent.service.execute.react.printer;
...
@Slf4j
@Setter
public class ResponseBodyPrinter implements Printer {
    private ResponseBodyEmitter emitter;
    private String requestId;
    private Integer agentType;

    public ResponseBodyPrinter(ResponseBodyEmitter emitter, String requestId, Integer agentType) {
    ...
    public void send(String messageId, String messageType, Object message, String digitalEmployee, Boolean isFinal) {
        try {
            ...
            log.info("{} printer send {} {} {}", requestId, messageType, message, digitalEmployee);
            ...
            switch (messageType) {
                ...
                case "task_summary":
                    if (message instanceof Map) {
                        ...
                        log.error("printer task_summary format is illegal");
                    }
                    break;
                case "plan_thought":
            ...
            log.error("printer send error ", e);
        }
    }

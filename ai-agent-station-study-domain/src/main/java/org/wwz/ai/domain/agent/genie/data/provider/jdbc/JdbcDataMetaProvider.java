...
import org.wwz.ai.domain.agent.genie.data.jdbc.connection.ConnectionWrapper;
import org.wwz.ai.domain.agent.genie.data.jdbc.connection.JdbcConnectionFactory;
import org.wwz.ai.domain.agent.genie.data.provider.DataMetaProvider;

import java.sql.*;
import java.util.ArrayList;
import java.util.List;

import static org.wwz.ai.domain.agent.genie.data.jdbc.catalog.AbstractJdbcCatalog.typeConvert;

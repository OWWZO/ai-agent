...
from reactor_tool.tool.dataprep._data.artifacts import ArtifactRef, parse_artifact_ref
...
def _read_local(path: Path, kind: str) -> list[dict[str, Any]]:
    ...
    if kind == "csv" or suffix == ".csv":
        from reactor_tool.tool.dataprep._path_safe import open_read_text_nofollow

...
public interface IAgentMessageService {
     ...
     * 插入占位消息(流式开始前)
     */
    AgentMessage insertPlaceholder(Long conversationId, String sessionId, String requestId,
                                   String query, Integer agentType, String filesJson);

    /**
     * 流式完成后更新消息全量数据
     */
    void completeMessage(Long messageId, String response, String thought,
     ...
     * 标记消息为错误状态
     */
    void markError(Long messageId, String partialResponse, String partialThought,
                   String renderSnapshotJson, String metricsJson);

    /**
     * 标记消息为强制停止
     */
    void markForceStop(Long messageId, String partialResponse, String partialThought,

...
//            }
            ...
            if ("struct_parse".equals(functionCallType)) {
                ...
                ReactorConfig reactorConfig = SpringContextHolder.getApplicationContext().getBean(ReactorConfig.class);
                stringBuilder.append(reactorConfig.getStructParseToolSystemPrompt());
    ...
    private CompletableFuture<ToolCallResponse> askToolWithChatClientStructParse(
        ...
        try {
            ...
            promptBuilder.append(reactorConfig.getStructParseToolSystemPrompt()).append("\n\n");
...
""");
    ...
    public CompletableFuture<ToolCallResponse> callOpenAIFunctionCallStream(AgentContext context, Map<String, Object> params) {
        ...
        try {
            ...
            ReactorConfig reactorConfig = SpringContextHolder.getApplicationContext().getBean(ReactorConfig.class);
            String[] interval = reactorConfig.getMessageInterval().getOrDefault("llm", "1,3").split(",");

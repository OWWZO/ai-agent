...
:mod:`reactor_tool.docgen.slides`; this module is a thin translation of that
        ...
        *,
        ...
        for span in parse_inline(text):
            if span.math:
                ...
                from reactor_tool.docgen.mathtext import latex_to_unicode
                from reactor_tool.docgen.omml import omml_pptx_alternate
